...
//			'hide_on_screen',
	...
	public static function get_custom_fields( $per_page = 200, $page_number = 1 ) {
		...
		$sql .= sprintf( ' WHERE meta_key IN (%s) LIMIT %d OFFSET %d', self::include_custom_fields_list(), $per_page, $offset );
	...
	public static function record_count() {
		...
		$sql .= sprintf( " meta_key IN (%s)", self::include_custom_fields_list() );
