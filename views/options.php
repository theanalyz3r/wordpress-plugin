<div class="wrap">
  ...
  <table class="form-table">
    <tr class="qordoba-bulk" data-action="qordoba_send_bulk" data-timestamp="<?php print current_time('timestamp'); ?>">
      <th>
      ...
      <td>
        <?php if ($has_updated_content): ?>
          ...
          <div class="qordoba-status" data-items="<?php print $updated_posts + $updated_terms; ?>" style="position:relative; max-width:400px; border:solid 0px #cddc39;">
            ...
            <div class="qordoba-progress" style="position:absolute;left:0;top:0;bottom:0;width:0%;background:#cddc39;z-index:-1;"></div>
          </div>
    ...
    <tr class="qordoba-bulk" data-action="qordoba_download_bulk" data-timestamp="<?php print current_time('timestamp'); ?>">
      <th>
      ...
      <td>
        ...
        <?php if ($has_queued_content): ?>
          ...
          <div class="qordoba-status" data-items="<?php print $queued_posts + $queued_terms; ?>" style="position:relative; max-width:400px; border:solid 0px #cddc39;">
            <div class="qordoba-info">
