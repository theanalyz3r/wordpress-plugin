  <table class="form-table">
    <tr class="qordoba-bulk" data-action="qordoba_pll_download_strings" data-timestamp="<?php print current_time('timestamp'); ?>">
      <th>
      ...
      <td>
        <?php if ($version): ?>
          ...
          <div class="qordoba-status" data-items="0" style="position:relative; max-width:400px; border:solid 0px #cddc39;">
